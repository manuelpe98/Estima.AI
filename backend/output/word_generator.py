...
def build_word(voci: list[ComputoVoce], meta: ProjectMeta, note_metodologiche: list[str],
    ...
    doc.add_paragraph(
        ...
        "sono comunque incluse nell'elenco come segnaposto, evidenziate in giallo con quantità a zero (il "
        "prezzo, quando disponibile nel prezzario di riferimento, è comunque indicato a titolo orientativo): "
        "vanno completate a mano dal tecnico dopo verifica sugli elaborati generali/di dettaglio. Il "
